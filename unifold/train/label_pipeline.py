...
from unifold.model.all_atom import atom41_to_frames
from unifold.model.all_atom import atom41_to_torsion_angles
...
def make_atom14_data(prot):
  ...
  [
    ...
    "atom14_gt_exists",
    "atom14_gt_positions",
    "residx_atom14_to_atom41",
    "residx_atom41_to_atom14",
    "atom41_atom_exists",
...
def make_atom14_positions(prot):
  ...
  #        corresponding values should be np.ndarray of shape [NR, ?], [NR, 41, 3] and [NR, 41].
  restype_atom14_to_atom41 = []  # mapping (restype, atom14) --> atom41
  ...
  residx_atom14_to_atom41 = restype_atom14_to_atom41[prot['aatype_index']]
  ...
  residx_atom14_gt_mask = residx_atom14_mask * np.take_along_axis(
      prot["all_atom_mask"], residx_atom14_to_atom41, axis=1).astype(np.float32)

  # Gather the ground truth positions.
  residx_atom14_gt_positions = residx_atom14_gt_mask[:, :, None] * (
      np.take_along_axis(prot["all_atom_positions"],
                         residx_atom14_to_atom41[..., None],
                         axis=1))
  ...
  prot["residx_atom14_to_atom41"] = residx_atom14_to_atom41

  # Create the gather indices for mapping back.
  residx_atom41_to_atom14 = restype_atom41_to_atom14[prot['aatype_index']]
  prot["residx_atom41_to_atom14"] = residx_atom41_to_atom14
  ...
  residx_atom41_mask = restype_atom41_mask[prot['aatype_index']]
  prot["atom41_atom_exists"] = residx_atom41_mask
  ...
  restype_atom14_is_ambiguous = np.zeros((22, 14), dtype=np.float32)
  for resname, swap in residue_constants.residue_atom_renaming_swaps.items():
...
def make_torsion_angles(prot):
  ...
  torsion_angles_dict = atom41_to_torsion_angles(
      aatype=aatype_index,
